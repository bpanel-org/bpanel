...
var ExpandedRow = (function(_PureComponent) {
  ...
  function ExpandedRow() {
    ...
    return (0, _possibleConstructorReturn3.default)(
      this,
      (ExpandedRow.__proto__ || (0, _getPrototypeOf2.default)(ExpandedRow)
    ...
    [
      {
        ...
        value: function formatExpandedData() {
          var expandedData = this.props.expandedData;
          var hash = expandedData.hash,
            prevBlock = expandedData.prevBlock,
            merkleRoot = expandedData.merkleRoot,
            bits = expandedData.bits,
            nonce = expandedData.nonce;
        ...
        get: function get() {
          return {
            ...
            expandedData: _propTypes2.default.shape({
              ...
              prevBlock: _propTypes2.default.string,
              merkleRoot: _propTypes2.default.string,
              bits: _propTypes2.default.number,
              nonce: _propTypes2.default.number
            }),
...
exports.default = connectTheme(ExpandedRow);
