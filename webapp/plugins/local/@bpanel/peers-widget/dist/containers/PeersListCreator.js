...
var PeerComponentCreator = function PeerComponentCreator(Component) {
  var peers =
      ...
      [
        {
          ...
          value: function render() {
            var peerList = void 0;
            if (peers.length > 0) {
              peerList = _react2.default.createElement(Component, {
                peers: peers
              });
            } else {
...
exports.default = (0, _ErrorWrapper2.default)(PeerComponentCreator);
